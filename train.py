...
class Instructor:
    ...
    def _train(self, criterion, optimizer,contrastiveLoss_sentiment):
        max_test_acc = 0
        max_test_f1 = 0
        global_step = 0
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                # polabel = sample_batched['polabel'].to(self.opt.device)

                outputs,vaeloss= self.model(inputs)
                loss1 = criterion(outputs, targets)
                cl_loss = contrastiveLoss_sentiment(outputs, targets)
    ...
    def run(self):
        ...
        self._reset_params()
        max_test_acc, max_test_f1 = self._train(criterion, optimizer,contrastiveLoss_sentiment )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='SVGCN', type=str)
    parser.add_argument('--dataset', default='twitter', type=str, help='twitter, rest14, lap14, rest15, rest16,twitter')
    ...
    input_colses = {
        'svgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
        #sdat_graph
    }
    initializers = {
